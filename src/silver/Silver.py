...
# MAGIC %md
# MAGIC - Tratar valores nulos
# MAGIC - Adicionar coluna de valor total de cada transação
# MAGIC - A partir de agregações, obter estatísticas de vendas (total de vendas por produto, por categoria, por seller)
# MAGIC - Calcular RFV para os clientes
...
# MAGIC %md
# MAGIC #### bronze_olist_order_payments_dataset: payment_value_is_above_zero (9 registros)
# MAGIC
